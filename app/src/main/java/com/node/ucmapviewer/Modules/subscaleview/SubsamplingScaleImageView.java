...
package com.node.ucmapviewer.Modules.subscaleview;
...
import com.node.ucmapviewer.Modules.subscaleview.decoder.CompatDecoderFactory;
import com.node.ucmapviewer.Modules.subscaleview.decoder.DecoderFactory;
import com.node.ucmapviewer.Modules.subscaleview.decoder.ImageDecoder;
import com.node.ucmapviewer.Modules.subscaleview.decoder.ImageRegionDecoder;
import com.node.ucmapviewer.Modules.subscaleview.decoder.SkiaImageDecoder;
import com.node.ucmapviewer.Modules.subscaleview.decoder.SkiaImageRegionDecoder;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (maxTouchCount > 0) {
                    if (touchCount >= 2) {
                        ...
                        // One finger zoom
                        // Stole Google's Magical Formula鈩� to make sure it feels the exact same
