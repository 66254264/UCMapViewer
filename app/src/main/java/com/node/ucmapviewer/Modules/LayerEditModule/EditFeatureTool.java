...
public class EditFeatureTool implements GestureDetector.OnGestureListener,UCFeatureLayerListener,MapOperTool{
    ...
    public EditFeatureTool(MapView mapView,UCFeatureLayer layer)
    {
        mMapView=mapView;
        this.layer=layer;
    }
