...
public class UndoRedo
{
    ...
    public boolean canUndo()//是否可以undo
    {
        return !undoList.isEmpty();
    }

    public boolean canRedo()//是否可以redo
    {
        return !redoList.isEmpty();
    }

    public int undo()//进行undo
    {
        if (!canUndo()) return 0;
    ...
    public void addUndo(int type,UCFeatureLayer layer,Feature oldFeature,Feature newFeature)//添加一个操作
    {
