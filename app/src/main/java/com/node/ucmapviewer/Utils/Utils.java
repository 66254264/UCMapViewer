...
//	}
    ...
    /**
     * ∏˘æ›º∏∫Œ∂‘œÛ≤√«–º∏∫Œ∂‘œÛ£¨÷ß≥÷”√√Ê≤√œﬂ°¢”√√Ê≤√√Ê°¢”√œﬂ≤√√Ê
     * @param target ƒø±Íº∏∫Œ∂‘œÛ£¨’‚∏ˆº∏∫Œ∂‘œÛ±æ…Ì≤ªª·∏ƒ±‰£¨∂¯Õ®π˝∑µªÿ÷µ¿¥∏Ê÷™≤√«–Ω·π˚
     * @param ref ≤Œøºº∏∫Œ∂‘œÛ
     * @return ≤√«–µƒΩ·π˚£¨ «“ª∏ˆº∏∫Œ∂‘œÛ ˝◊È
     */
    public static Geometry[] cut(Geometry target,Geometry ref)
    {
        ...
        {//ƒø±Í «∂‡√Êµƒ«Èøˆ√ª”–¥¶¿Ì
            ...
            else
            {
                ...
                for (int i=0;i<10;++i)//≥¢ ‘∑≈¥Û∑√Œ À—À˜ Æ¥Œ
                {
                    env.expandBy(env.getWidth()*5, env.getHeight()*5);
                    //env.expand(10, 10, false);//Ω´env∑≈¥Û÷Æ∫Û÷ÿ–¬º∆À„
