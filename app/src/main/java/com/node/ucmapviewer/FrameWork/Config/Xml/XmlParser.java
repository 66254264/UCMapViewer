...
package com.node.ucmapviewer.FrameWork.Config.Xml;

import android.content.Context;


import com.node.ucmapviewer.FrameWork.MapModule.Resource.Constant;
...
public class XmlParser {
	...
	private final static String XML_NODE_WIDGETCONTAINER = "modulecontainer";
	private final static String XML_NODE_MENUS = "menus";

	private final static String XML_NODE_WIDGET_GROUP = "modulegroup";
	private final static String XML_NODE_WIDGET = "module";
			...
			while (eventType != XmlPullParser.END_DOCUMENT)
			{
				...
				switch (eventType) 
				{
					...
					case XmlPullParser.START_TAG:
						if(XML_NODE_WORKSPACE.equals(nodeName)){//workPath
